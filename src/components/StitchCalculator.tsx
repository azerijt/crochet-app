...
export default function StitchCalculator(): JSX.Element {
    ...
    function saveStitchClick(){
        setStitchSize({stitchName: '', stitchWidth: stitchWidth, stitchHeight: stitchHeight});
    }
    ...
    return (
        <div>
            ...
            {stitchSize? <p>Stitch {stitchSize.stitchName}: {stitchSize.stitchWidth} x {stitchSize.stitchHeight} cm</p>: null}
            </div>
            <PatternCalculator stitchName=" "
